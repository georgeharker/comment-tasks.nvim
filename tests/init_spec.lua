...
describe("comment-tasks plugin initialization", function()
    ...
    describe("plugin setup", function()
        ...
        it("should have status update functions", function()
            ...
            assert.is_function(comment_tasks.update_task_status_from_comment)
            assert.is_function(comment_tasks.add_file_to_task_sources)
        end)
    ...
    describe("utility functions", function()
        ...
        it("should trim comment prefixes correctly", function()
            ...
            assert.equals("Fix this bug", utils.trim_comment_prefixes("TODO: Fix this bug", nil))
            assert.equals("Another issue", utils.trim_comment_prefixes("FIXME: Another issue", nil))
            assert.equals("Critical problem", utils.trim_comment_prefixes("BUG: Critical problem", nil))
            assert.equals("Memory leak", utils.trim_comment_prefixes("HACK: Memory leak", nil))
        end)
